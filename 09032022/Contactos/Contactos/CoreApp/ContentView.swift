...
struct ContentView: View {
    ...
    // SQL: SELECT * FROM CONTACTOS WHERE APELLIDO = 'FERNANDEZ' ORDER BY ASC
    /*@FetchRequest(entity: Contactos.entity(), sortDescriptors: [NSSortDescriptor(keyPath: \Contactos.nombre, ascending: true)], predicate: NSPredicate(format: "apellido = %@", "Fernandez")) var contactos: FetchedResults<Contactos>*/
