//
//  ContactosCellTableViewCell.swift
//  MiTaskVersion3.0
//
...
class ContactosCellTableViewCell: UITableViewCell, ReuseIdentifierProtocol  {
...
extension ContactosCellTableViewCell: ContactosCellProtocol{
    func configuracionCell(data: ArrayContact){
