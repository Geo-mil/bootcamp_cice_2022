...
final class HomeTabBarCoordinator {
    static func homeViewController() -> UITabBarController{
        ...
        let iconNuevaTarea = UITabBarItem(title: "Mis Contactos", image: UIImage(systemName: "pencil.and.outline"), selectedImage: UIImage(systemName: "pencil.and.outline"))
        
        let iconListaTarea = UITabBarItem(title: "Mis Contactos", image: UIImage(systemName: "text.redaction"), selectedImage: UIImage(systemName: "text.redaction"))
